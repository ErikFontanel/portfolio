...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"node_modules/slugify/index.js":[function(require,module,exports) {
var define;
...
var _default = [{
  ...
  description: 'For green start-up incubator I designed their online magazine and start-up directory.',
  path: 'let-it-grow',
...
var projectsContainer = document.createDocumentFragment();
...
var getGallery = function getGallery(urls) {
  if (urls.length > 0) {
    var htmlstring = urls.map(function (url) {
      return "<figure class=\"".concat(url.search(/\D\.png$/g) >= 0 ? 'mobile' : 'desktop', "\"><img src=\"/").concat(url, "\"/></figure>");
    });
    return htmlstring.join('');
  }
};

var renderProject = function renderProject(node) {
  var title = node.title,
      ...
      date = node.date,
      url = node.url;
  var id = (0, _slugify.default)(title);
  var web = url ? "<br><a href=\"".concat(url, "\">Visit</a>") : '';
  var year = date ? "Year: ".concat(date, "<br>") : '';
  var collab = collaboration ? "With: ".concat(collaboration, "<br>") : '';
  var service = services ? "Services: ".concat(services.join(', '), "<br>") : '';
  var gallery = getGallery(images);
  var html = "\n  <article id=\"".concat(id, "\" class=\"project\">\n    <div class=\"project-info\">\n      <h1 class=\"project-title listheader\">").concat(title, "</h1>\n      <p>").concat(description, "</p>\n      <p class=\"project-meta\">\n      ").concat(service, "\n      ").concat(collab, "\n      ").concat(year, "\n      ").concat(web, "\n      </p>\n    </div>\n\n    <div class=\"project-gallery\">\n      ").concat(gallery, "\n    </div>\n  </article>\n  ");
...
},{"slugify":"node_modules/slugify/index.js","~/content/projects":"content/projects.js","./src/intro":"src/intro.js"}],"../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "50136" + '/');
